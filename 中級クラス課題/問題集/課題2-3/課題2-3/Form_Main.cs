namespace 課題2_3
{
    public partial class Form_Main : Form
    {
        ...
        {
            string[] who = { "鼠", "牛", "虎", "兎", "竜", "蛇", "馬", "羊", "猿", "鳥" };
            string[] what = { "マイコン", "パソコン", "電子回路", "本", "机", "椅子", "洗濯機", "電子レンジ", "自転車", "車"};
            string[] how = { "組み立てた", "設計した", "壊した", "書いた", "利用した", "変えた", "買った", "売った", "運転した", "調べた" };
